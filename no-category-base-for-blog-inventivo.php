...
Tags: remove category, category base
Requires at least: 3.0
Tested up to: 5.2.2
Stable tag: 1.0.0
Text Domain: no-category-base-for-blog-inventivo
...
function no_category_base_permastruct()
{
	...
	if ( $wp_version >= 3.4 ) {
		...
		$wp_rewrite->extra_permastructs['category'][0] = 'blog/%category%';
	}
}
...
function no_category_base_rewrite_rules($category_rewrite)
{
	...
	foreach( $categories as $category ) {
		$category_nicename = 'blog/'.$category->slug;
